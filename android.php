...
function get_statistik(){
	...
	echo "ZEIT-INFO";
	echo "<br><strong>";
	echo (strstr($_user->_name,'(',true));
	echo "</strong><br>";
	echo "<br>";
	echo "Stundensaldo : ". $_monat->_SummeSaldoProMonat . " Std.";
	echo "<br>";
	echo "Urlaubsrest: ". $_jahr->_saldo_F . " Tage";
	echo "<br>";
	echo "<br>";
	echo "<u>Monats - Summen : </u>";
	echo "<br>";
	...
	if($_monat->_SummeFerien > 0){
		echo "Urlaub : ". $_monat->_SummeFerien  . "  Tage";
		echo "<br>";
	}
	if($_monat->_SummeKrankheit > 0){
		echo "Krankheit : ". $_monat->_SummeKrankheit  . " Tage";
		echo "<br>";
	}
	if($_monat->_SummeUnfall > 0){
		echo "Unfall : ". $_monat->_SummeUnfall . "  Tage";
		echo "<br>";
	}
	if($_monat->_SummeMilitaer > 0){
		echo "Militär : ". $_monat->_SummeMilitaer  . " Tage";
		echo "<br>";
	}
	if($_monat->_SummeIntern > 0){
		echo "Intern : ". $_monat->_SummeIntern  . " Tage";
		echo "<br>";
	}
	if($_monat->_SummeWeiterbildung > 0){
		echo "Weiterbildung : ". $_monat->_SummeWeiterbildung  . " Tage";
		echo "<br>";
	}
	if($_monat->_SummeExtern > 0){
		echo "Extern : ". $_monat->_SummeExtern  . " Tage";
		echo "\n";
	}
}
