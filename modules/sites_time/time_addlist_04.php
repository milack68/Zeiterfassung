...
<form name="insert" action="?action=insert_time_list&timestamp=<?php echo $_time->_timestamp ?>&token=<?php echo $token ?>" method="post" target="_self">
	<table width="100%" border="0" cellpadding="5" cellspacing="2">
		<tr>
			...
			<!-- input-Feld auf readonly gesetzt, um Rückdatierungen mit Datum zu verhindern -->
				<input type="text" name="_w_tag" value="<?php echo $_time->_tag; ?>"size="4" readonly>
			</td>
		</tr>
 		<tr>
			...
			<td class=td_background_tag align=left>
			<!-- input-Feld auf readonly gesetzt, um Rückdatierungen mit Datum zu verhindern -->
				<input type="text" name="_w_monat" value=" <?php echo $_time->_monat; ?> "size="4" readonly> 
			</td>
		</tr>
		<tr>
			...
			<td class=td_background_tag align=left>
			<!-- input-Feld auf readonly gesetzt, um Rückdatierungen mit Datum zu verhindern -->
				<input type="text" name="_w_jahr" value="<?php echo $_time->_jahr; ?> "size="4" readonly>
			</td>
		</tr>
		<tr>
